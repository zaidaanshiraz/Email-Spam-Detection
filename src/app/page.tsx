...
export default function Home() {
  ...
  // Public landing page: do not redirect unauthenticated users.
  // Authenticated users will see the dashboard below.
  useEffect(() => {
    // No-op for unauthenticated users; keep them on the landing page.
  }, []);
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-6">
        <div className="max-w-3xl text-center space-y-6">
          ...
          <h1 className="text-3xl md:text-4xl font-bold font-headline">
            Transformer-Driven NLP Framework for High-precision Phishing Email Identification
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link href="/login?role=user">
              <Button className="min-w-40">User Login</Button>
            </Link>
            <Link href="/login?role=admin">
              <Button variant="outline" className="min-w-40">Admin Login</Button>
            </Link>
          </div>
        </div>
      </div>
